...
from internlm.model.ssm.ss_kernel import SSKernel
from internlm.core.context import IS_TENSOR_PARALLEL, ParallelMode
from internlm.core.context.parallel_context import global_context as gpc
try:
    from internlm.model.ssm.ops.fftconv import fftconv_func
except ImportError:
    fftconv_func = None
...
class H3(nn.Module):
    ...
    def forward(self, u, inference_params=None):
        ...
        # Compute SS Kernel
        self.ssm_k_kernel = self.ssm_k_kernel.to(torch.float32)
        self.kernel = self.kernel.to(torch.float32)
