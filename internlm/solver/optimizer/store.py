...
class ParameterStore(BaseStore):
    ...
    def __init__(self, dp_paralle_mode):
        ...
        self._no_last_bucket_reduced_param = []
        self._last_bucket_reduced_param = []
        self._no_last_bucket_reduced_grad = []
    ...
    def add_reduced_data_for_compute_norm(self, param, last_bucket=False):
        if last_bucket:
            self._last_bucket_reduced_param.append(param)
            self._last_bucket_reduced_grad.append(param.grad)
        else: 
            self._no_last_bucket_reduced_param.append(param)
            self._no_last_bucket_reduced_grad.append(param.grad) 
        
    def get_reduced_data_for_compute_norm(self, last_bucket=False):
        if not last_bucket:
            return self._no_last_bucket_reduced_param, self._no_last_bucket_reduced_grad
        else:
