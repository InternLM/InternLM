...
data = dict(
    ...
    # option for using Pytorch FSDP, acctivated by setting use_fsdp=True
    # when use_fsdp=False and use_communication=True, original setting is activated
    use_fsdp=True,
    use_communication=False,
    # add hook for debug, not necessary
    hook_debug=False,
)
