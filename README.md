...
\[2024.01.31\] We release InternLM2-1.8B, along with the associated conversation model. This model provides a cheaper deployment option while maintaining leading performance.
