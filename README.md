...
\[2024.08.01\] We release InternLM2.5-1.8B, InternLM2.5-1.8B-Chat, InternLM2.5-20B and InternLM2.5-20B. See [model zoo below](#model-zoo) for download or [model cards](./model_cards/) for more details.
